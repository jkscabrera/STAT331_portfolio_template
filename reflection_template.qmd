...
[**My Grade:**]{.ul} I believe my grade equivalent to course work evidenced below to be an B.
...
major_avo |>
  separate(col = Date,
           ...
           sep = "-") |>
  group_by(Month) |>
  summarize(month_volume = sum(total_volume),
            month_avg_vol = mean(total_volume)) |>
  slice_max(month_avg_vol)
