...
execute:
  ...
  error: true
---
# code-tools: opens up source code (quarto file)
# Lab Instructions
...
From the output "30463 15", the data set, surveys, has 30,463 rows and 15 columns.
...
In the surveys data set, there are 7 numeric and 7 character variables. There is also one Date variable, 
but after further research, I believe it's saved as "the number of days since 1970-01-01, with negative 
values for earlier dates" making it numeric as well.
...
```{r jitter}
# Code for question 6! 
# https://r02pro.github.io/jitter-count.html#jitter
ggplot(data = surveys) +
