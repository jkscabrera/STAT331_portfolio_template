...
allison_f |>
  ...
  knitr::kable(format = "html",
               col.names = c("State",
                             "Year",
                             "Count"),
               caption = "Summary of Frequency of Female Birthed Allisons in Each State") |>
  kableExtra::kable_classic(html_font = "Arial") |>
  kableExtra::kable_styling(bootstrap_options = "striped")
...
5.  Write out the estimated regression equation.
    ...
    **Total Number of Allisons = 209689.8 -101.5(Year)**
...
allan_names |>
  knitr::kable(format = "html",
               col.names = c("Name",
                             ...
                             "State",
                             "Count"),
               caption = "Frequency and Sex of 'Allen', 'Allan', and 'Alan' Individually in Each State") |>
  kableExtra::kable_classic(html_font = "Arial") |>
  kableExtra::kable_styling(bootstrap_options = "striped")
