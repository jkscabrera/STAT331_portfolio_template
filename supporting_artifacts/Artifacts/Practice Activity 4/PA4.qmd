...
What regions were not removed from the `military_clean` dataset? Use their correct capitalization **and** punctuation! Data Organization
...
ggplot(data = military_long,
  ...
  labs(x = "Spending (% of total Government Spending)", y = "Year", title = "US Military Spending from 1988 to 2019")
```
